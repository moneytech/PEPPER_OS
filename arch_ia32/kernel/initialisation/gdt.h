...
#define SEG_DESCTYPE(x) ((x) << 0x04)  //Description du type (0 for system / 1 for code/data  )
...
#define SEG_GRAN(x) ((x) << 0x0F)  //Granularité (0 pour 1o - 1Mo , 1 pour 4Ko - 4Go)
...
#define GDT_CODE_PL0 SEG_CODE_E_R_A | SEG_DESCTYPE(1) | SEG_PRIV(0) | \
                         SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |    \
                         SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_DATA_PL0 SEG_DATA_R_W_A | SEG_DESCTYPE(1) | SEG_PRIV(0) | \
                         SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |    \
                         SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_STACK_PL0 SEG_DATA_R_W_EX_A | SEG_DESCTYPE(1) | SEG_PRIV(0) | \
                          SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |       \
                          SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_CODE_PL3 SEG_CODE_E_R_C_A | SEG_DESCTYPE(1) | SEG_PRIV(1) | \
                         SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |      \
                         SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_DATA_PL3 SEG_DATA_R_W_A | SEG_DESCTYPE(1) | SEG_PRIV(1) | \
                         SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |    \
                         SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_STACK_PL3 SEG_DATA_R_W_EX_A | SEG_DESCTYPE(1) | SEG_PRIV(1) | \
                          SEG_PRES(1) | SEG_SAVL(1) | SEG_LONG(0) |       \
                          SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_TSS SEG_CODE_E_A | SEG_DESCTYPE(0) | SEG_PRIV(3) | \
                    SEG_PRES(1) | SEG_SAVL(0) | SEG_LONG(0) |  \
                    SEG_SIZE(0) | SEG_GRAN(0)
