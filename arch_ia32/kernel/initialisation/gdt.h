...
#define GDT_CODE_PL0                                                           \
  SEG_CODE_E_R_A | SEG_DESCTYPE(1) | SEG_PRIV(0) | SEG_PRES(1) | SEG_SAVL(1) | \
      SEG_LONG(0) | SEG_SIZE(1) | SEG_GRAN(1)

#define GDT_DATA_PL0                                                           \
  SEG_DATA_R_W_A | SEG_DESCTYPE(1) | SEG_PRIV(0) | SEG_PRES(1) | SEG_SAVL(1) | \
      SEG_LONG(0) | SEG_SIZE(1) | SEG_GRAN(1)
...
#define GDT_DATA_PL3                                                           \
  SEG_DATA_R_W_A | SEG_DESCTYPE(1) | SEG_PRIV(1) | SEG_PRES(1) | SEG_SAVL(1) | \
      SEG_LONG(0) | SEG_SIZE(1) | SEG_GRAN(1)
